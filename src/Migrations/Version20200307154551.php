 ...
 */
final class Version20200307154551 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE server_group (id INT AUTO_INCREMENT NOT NULL, group_name VARCHAR(15) NOT NULL, group_owner_email VARCHAR(25) NOT NULL, group_description LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
